...
namespace WebApplication1.Controllers
{
    public class DonationsController : Controller
    {
        ...
        public PartialViewResult DonationIntroduction()
        {
            return PartialView("~/Views/donations/_DonationIntroduction.cshtml");
        }
        ...
        {
            if (Session["role"] != null && Session["role"].ToString() == "USR")
            {
                return View();
            }
            else
